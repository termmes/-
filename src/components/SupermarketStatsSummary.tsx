  ...
  return (
    <div className="bg-white rounded-3xl p-4 sm:p-6 border border-gray-200/90 shadow-2xs space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-gradient-to-br from-slate-50 to-gray-50/80 p-3.5 sm:p-4 rounded-2xl border border-gray-200/80 flex flex-col justify-between">
          ...
          <div className="mt-2 flex items-baseline gap-1.5">
            ...
            <span className="text-xs text-gray-500 font-medium">منتج ({totalVariations} طعم/حجم)</span>
          </div>
        </div>

        {/* 2. In Stock */}
        <div className="bg-gradient-to-br from-emerald-50/50 to-teal-50/30 p-3.5 sm:p-4 rounded-2xl border border-emerald-100 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-emerald-800">الأصناف المتوفرة</span>
          ...
          <div className="mt-2 flex items-baseline gap-1.5">
            ...
            <span className="text-xs text-emerald-600 font-medium">متوفر وجاهز للبيع</span>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-rose-800">النواقص الحرجة</span>
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-xs text-rose-500 font-medium">صنف ناقص</span>
            </div>
            {outOfStockCount > 0 && (
        ...
        >
          ...
          <div className="mt-2 flex items-baseline justify-between">
            <div className="flex items-baseline gap-1.5">
              ...
              <span className="text-xs text-indigo-600 font-medium">ملاحظة/طلبية توريد</span>
            </div>
